    ...
    <nav className="fixed top-0 left-0 w-full shadow-sm flex items-center justify-between px-8 py-6 z-10 bg-opacity-80 backdrop-filter backdrop-blur-sm">
      ...
      <div className="hidden items-center space-x-6 sm:hidden md:hidden lg:flex xl:flex">
        <button
          ...
          className="text-xl hover:text-[#7c4dff]"
        >
          Technologies
        </button>
        <button
      ...
      <div className="flex items-center justify-center gap-4 text-3xl">
        ...
        >
          <FaLinkedin className="text-gray-200 m-0 p-0 hover:border hover:border-blue-600 hover:rounded-sm" />
        </a>
        <a
          ...
          rel="noopener noreferrer"
        >
          <FaGithub className="text-gray-200 m-0 p-0 hover:border-2 hover:border-gray-700 hover:rounded-xl" />
        </a>
      </div>
    </nav>
  );
