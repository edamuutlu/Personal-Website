...
function Technologies() {
  return (
    <section id="technologies" className="pb-24 overflow-hidden">
      <motion.h2
        whileInView={{ opacity: 1, y: 0 }}
        initial={{ opacity: 0, y: -100 }}
        transition={{ duration: 1.5 }}
        className="my-20 p-1 text-center text-4xl font-semibold bg-gradient-to-b from-[#72A0C1] to-[#A3C1AD] bg-clip-text tracking-tight text-transparent"
      >
        Technologies
      </motion.h2>
      <motion.div
